...
function Product_Side(props) {
    ...
    return (
        <div key={product._id} className="shop-item border-bottom d-flex p-4" >
            <img className="side-product__img" src={product.product_img} alt="Card image"></img>
            <div className="side-product__title mx-4 ">
                <Link to="/detail" onClick={() => viewProduct(product._id)} className="title ml-auto">{product.product_name}</Link>
